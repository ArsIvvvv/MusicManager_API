...
{
    Task<IEnumerable<Music>> GetAllAsync(bool includeExecutors, bool trackingEnable, CancellationToken cancellationToken = default);
    Task <Music?> GetByIdAsync(Guid id, bool includeExecutors, CancellationToken cancellationToken = default);
